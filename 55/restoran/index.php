...
<head>
    ...
    <title>ZF Restoran | Aplikasi Restoran SMK</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 mt-4">
                <h2><a href="index.php">ZF Restoran</a></h2>
            </div>
        ...
        <div class="row mt-5">
            <div class="col-md-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="?f=home&m=produk&id=<?php echo $r['idkategori']?>"><?php echo $r['kategori']?></a></li>
                    <?php endforeach ?>
                </ul>
                <?php }?>
            </div>
